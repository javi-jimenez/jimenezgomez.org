...
**Consultor Independiente / Brisecom** · 2020 - Presente
...
**Tecnologías:** SAST, Threat Modeling, DevSecOps, OWASP, S-SDLC

### Programador Senior Java
**Clever Global (antes iSOCO)** · 2015 - 2019
...
**Tecnologías:** Java, JSF, Spring, Docker, Microservicios, SonarQube

### Programador Open Source
**Fundació guifi.net & UPC** · 2013 - 2014
...
**Tecnologías:** Linux, Open Source, Redes Comunitarias, LXC
...
AWS Solutions Architect · Docker · Linux Admin · Git · CI/CD (Jenkins) · MySQL/PostgreSQL
...
🔗 [Código en GitHub](http://www.github.com/javi-jimenez/gcodis.git)
...
🔗 [Código en GitHub](http://www.github.com/javi-jimenez/ddnsc.git)
...
¿Interesado en colaborar en proyectos de seguridad, desarrollo seguro o ética en IA? No dudes en contactarme.
