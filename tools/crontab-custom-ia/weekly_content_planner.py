#!/usr/bin/env python3
"""
Local copy of the weekly content planner adapted for running from ~/data/crontab-custom-ia
"""
import os
import sys
import json
...
BASE_DIR = Path.home() / 'data' / 'crontab-custom-ia'
POSTS_DIR = Path.cwd() / 'content' / 'posts'
FEEDS = [
...
def create_issue(title, body):
    if not REPO or not TOKEN:
        print('Skipping issue creation: GITHUB_REPOSITORY or GITHUB_TOKEN not set')
        return
